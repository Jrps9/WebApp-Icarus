...
Reservations = Reservation.create!([
    {user: user1, name: "Belle-île en Mer", destination: "Porquerolles", latitude: 42.998653, longitude: 6.167719},
    {user: user1, name: "Le Bitch-Volley", destination: "Hyères", latitude: 43.035147, longitude: 6.134487},
    {user: user1, name: "Ecouter du Jazz", destination: "Les Ambiez", latitude: 43.070172, longitude: 5.786512},
    {user: user1, name: "Boire des canons", destination: "Marseille", latitude: 43.220103, longitude: 5.330713},
    {user: user1, name: "Chiller sur la plage", destination: "Cavalaire", latitude: 43.181193, longitude: 6.546536},
    {user: user1, name: "Faire du surf", destination: "Saint-Cyr", latitude: 43.172589, longitude: 5.686602},
    {user: user1, name: "Manger des oursins", destination: "Le Pradet", latitude: 43.089240 , longitude: 6.020089},
    ])
